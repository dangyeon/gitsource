 ...
 *  
 */
// DatagramClient_Echo.c : Defines the entry point for the console application.
//
...
//		fflush(stdin);
					...
					(struct sockaddr*)&servAddr, sizeof(servAddr))) !=-1 ) 
		{
			...
			if ((nReceived = recvfrom(hSock, app_wBuffer, APP_SND_BUF_SIZE, 0,
					(struct sockaddr*)&servAddr, &nLen)) != -1 )
			{
